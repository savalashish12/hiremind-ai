        ...
        {activeTab === "jobs" && (
          ...
          >
            ...
            <div className="space-y-6">
              ...
              {jobs.length === 0 ? (
                <p className="text-slate-500 text-xs py-10 text-center font-medium italic bg-slate-900/20 rounded-2xl border border-slate-850">
                  No jobs posted yet. Build a new vacancy above to start sourcing candidates!
                </p>
              ) : (
